...
The next phase of the analysis focuses on using the data to address the impacts of air quality on Boise’s economy. Human-centered data science (HCDS) principles guide the interpretation of the results, ensuring the findings are relevant to the community’s well-being. The selected metrics for this analysis include **GDP**, **unemployment rates**, and **Micron's stock performance**.
